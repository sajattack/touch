/*
 * touch_sw46104.c - SiW touch driver glue for SW46104
 *
...
#define CHIP_ID						"6104"
#define CHIP_DEVICE_NAME			"SW46104"
#define CHIP_COMPATIBLE_NAME		"siw,sw46104"
#define CHIP_DEVICE_DESC			"SiW Touch SW46104 Driver"

#define CHIP_TYPE					CHIP_SW46104
...
#define CHIP_SENSELESS_MARGIN		(0x57)	//87 pixel : 5mm
...
static const struct siw_hal_reg_quirk chip_reg_quirks[] = {
	...
	{ .old_addr = SPR_BOOT_CTL, .new_addr = 0x004, },
	{ .old_addr = SPR_SRAM_CTL, .new_addr = 0x005, },
	{ .old_addr = SPR_BOOT_STS, .new_addr = 0x10B, },
	{ .old_addr = SPR_SUBDISP_STS, .new_addr = 0x110, },
	...
	{ .old_addr = INFO_CHIP_VERSION, .new_addr = 0x331, },
	{ .old_addr = INFO_CG_TYPE, .new_addr = 0x32C, },
	{ .old_addr = INFO_LOT_NUM, .new_addr = 0x32D, },
	...
	{ .old_addr = SPR_CODE_OFFSET, .new_addr = 0x022, },
	...
	{ .old_addr = SERIAL_DATA_OFFSET, .new_addr = 0x027, },
	/* */
	{ .old_addr = SPR_CODE_OFFSET, .new_addr = 0x022, },
	{ .old_addr = CODE_ACCESS_ADDR, .new_addr = 0xFD0, },
	{ .old_addr = DATA_I2CBASE_ADDR, .new_addr = 0xFD1, },
	...
	/* */
	{ .old_addr = PRD_IC_AIT_START_REG, .new_addr = ADDR_SKIP_MASK, },
	{ .old_addr = PRD_IC_AIT_DATA_READYSTATUS, .new_addr = ADDR_SKIP_MASK, },
	/* */
	{ .old_addr = SPR_CHARGER_STS, .new_addr = 0xC50, },
	{ .old_addr = IME_STATE, .new_addr = 0xC51, },
	/* */
